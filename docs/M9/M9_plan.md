# M9 Plan: Budget Invoice

## Module Specification
Summarized financial view with cost breakdown.
...
[Agent Execution Prompt - Ready to Copy for TEAMMATE: Antigravity - Budget Invoice]

> **Role:** Full-Stack Developer
>
> **Task:** Build the Budget Invoice module as specified in the PRD.
>
> **Context:**
> - **Feature Requirements:** Summarized financial view with cost breakdown.
...
> - **Database Tables:** trips, trip_activities
> - **API Endpoints:** 
> - **Dependencies:** M5
> - **File Attachments:** master_prd.md, architecture.md, module_prds/M9.md
>
> **Specific Instructions:**
> - Use exactly this tech stack: Next.js 14 App Router, Supabase JS client
> - Create these specific files: Required UI components and service files for Budget Invoice.
